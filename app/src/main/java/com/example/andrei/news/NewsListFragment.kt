package com.example.andrei.news
...
class NewsListFragment : FirebaseDbListFragment<News, NewsViewHolder>() {
    ...
    override fun getEmptyStyle(): EmptyStyle {
        return EmptyStyle(R.drawable.loading_error, "No news yet in database")
    }

    override fun getErrorStyle(error: DatabaseError): ErrorStyle {
        return ErrorStyle(R.drawable.loading_error, "An error occurred while fetching news")
    }
